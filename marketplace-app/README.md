...
JobMarketplaceBackend\marketplace-app -> npm run start gateway
JobMarketplaceBackend\marketplace-app -> npm run start user
JobMarketplaceBackend\marketplace-app -> npm run start auth
